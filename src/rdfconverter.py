...
def checkForBooleanAsString(uniquestrings):
...
def addPropertyToGraph(row,x,g,ns,curid,thecls,lang,curcol):
    subclass=False
...
def processColumns(prefix,seencols,x,curid,g,row,idcol,attns,thecls,lang,typemap):
